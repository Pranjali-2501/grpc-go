...
// (currently ext_proc and ext_authz on the client, and ext_authz on the server;
// OR in RLQS guards as those features are implemented).
func allowedGRPCServicesEnabled() bool {
	return envconfig.XDSClientExtProcEnabled || envconfig.XDSClientExtAuthzEnabled || envconfig.XDSServerExtAuthzEnabled
}
